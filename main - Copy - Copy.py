"""
ubind @poly
ulocate ore core true @coal @coal_x @coal_y @found building
print "coalx: "
print @coal_x
print "\ncoaly: "
print @coal_y
...
print @unit
print "\nunit_carried: "
sensor @unit_load @unit @totalItems
print @unit_load
printflush message1
ucontrol move @coal_x @coal_y 0 0 0
ucontrol mine @coal_x @coal_y 0 0 0
jump 12 lessThan @unit_load 30
