# Pokušaj slaganja tabova

# Tabovi: test, zadatak, kategorije
...
tab_tests = ttk.Frame(tabs)
tab_problems = ttk.Frame(tabs)
tab_categories = ttk.Frame(tabs)

tabs.add(tab_tests, text="Testovi")
tabs.add(tab_problems, text="Zadaci")
tabs.add(tab_categories, text="Kategorije")

tabs.pack(expand=1, fill='both')

# tab test
# odabir zadataka, provjera
preview_test = tk.Button(tab_tests, text = "Provjeri")
preview_test.pack()

# tab zadatak
# unos zadatka, konstanti, parametara, formula, provjera
preview_problem = tk.Button(tab_problems, text = "Provjeri")
preview_problem.pack()

# tab kategorije
# unos kategorija, brisanje kategorija
new_category = tk.Button(tab_categories, text = "New category")
new_subcategory = tk.Button(tab_categories, text = "New sub category")
new_category.pack()
new_subcategory.pack()
